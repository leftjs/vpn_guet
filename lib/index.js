...
function createInterfaces(newIp) {
  ...
  let newContent = util.format(raw, INNER_INTERFACE_NAME, INNER_INTERFACE_NAME, INNER_INTERFACE_NAME, newIp, OUTER_INTERFACE_NAME, OUTER_INTERFACE_NAME, SSID, PSK)
